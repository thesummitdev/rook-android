...
val LightOnBackground = Color(0xFF3A3F58)
val LightPrimary = Color(0xFF6B879B)
val LightOnPrimary = Color(0xFF5a5D6A)
val LightSurface = Color(0xFFEDF2F7)
val LightOnSurface = LightOnPrimary
val LightSecondary = Color(0xFF1067B1)
